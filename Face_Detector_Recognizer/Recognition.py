# When you run this code, it will start the webcame and recognize persons in a video.
# Make sure the haarcascade and model have the correct path.
# If you are using sqlite you don't need api call so you can remove "getStudentFromSQL" method.
